...
E1=(kf.^2+6*kf*lambda+kf+1);
E2=(kf.^3+kf.^2+6*kf.^2.*lambda+kf+1).*(kf+4.16582);
E3=(kf.^4+kf.^3+6*kf.^3.*lambda+kf.^2+kf+1).*(kf+4.16582).^2;

% E=E2/(E1^2);
% F=0.0392^2/9.26884e-4;

o=abs((E2/(E1.^2)-F1.^2/F2))+abs((E3/(E1.^3)-F1.^3/F3));
end
